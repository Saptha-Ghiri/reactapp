        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="h-64">
                <Line
                  data={getSensorHistoryChartData("temperature")}
                  options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    scales: {
            ...
            {/* Humidity Chart */}
            <div className="border rounded-lg p-4">
              <h3 className="text-md font-semibold mb-2">Humidity History</h3>
              <div className="h-64">
                <Line
                  data={getSensorHistoryChartData("humidity")}
                  options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    scales: {
            ...
            {/* Ultrasonic Chart */}
            <div className="border rounded-lg p-4">
              <h3 className="text-md font-semibold mb-2">Distance History</h3>
              <div className="h-64">
                <Line
                  data={getSensorHistoryChartData("ultrasonic")}
                  options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    scales: {
            ...
            {/* Gas Chart */}
            <div className="border rounded-lg p-4">
              <h3 className="text-md font-semibold mb-2">Gas Level History</h3>
              <div className="h-64">
                <Line
                  data={getSensorHistoryChartData("gas")}
                  options={{
                    responsive: true,
                    maintainAspectRatio: false,
                    scales: {
